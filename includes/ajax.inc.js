//--------------------------- AJAX AJOUT STAGE -----------------------------//
     ...
     jQuery(document).ready(function($){
      ...
      //affiche les options selon les études selectionnées
      jQuery(document).ready(function($){
         $('#etudes').change(function() {
             var value='';
             value=$('#etudes').val();
      ...
      //affiche les etudiants d'une classe pour l'ajout d'un stage'
      jQuery(document).ready(function($){
...
//--------------------------- FIN AJOUT STAGE -----------------------------//      
      ...
      //Fonction Jquery affichage des informations d'entreprise'
      jQuery(document).ready(function($){
