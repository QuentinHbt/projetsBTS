...
class C_Utilisateur extends Controleur{
    ...
    function coordonees(){
       ...
       // midification des coordonnées de l'utilisateur 
    ...
    //validation de modification des données personelles à l'utilisateur
    ...
    // affichage du choix de l'affichage des entreprises
    function afficherEntreprise(){
      ...
      //affiche toutes les entreprises sans critère 
    function afficherEntrepriseALL(){
     ...
     //affiche les entreprises triées par critéres    
    ...
    function validationcreerentreprise(){
        ...
        $msg='';    
        //vérifie si le login est présent dans la base de données si l'entreprise n'est pas déjà créé
       
      if($countEnt->NB=="0"){
        //mise en majuscule de la ville et de la forme juridique pour unifier ces 2 critére
    ...
    //mettre a jour les informations d'une entreprise
    ...
    //validation des modifications de l'entreprise
    function validerModifierEntreprise(){
        
        $this->vue->titreVue = "Modification informations entreprises";
        $entreprise = new M_LesDonneesCreationEntreprise();
        // préparer la liste des paramètres
        $lesParametres = array();
        // récupérer les données du formulaire
    ...
    //Validation de la création d'un stage
    function validationcreerstage(){

        $this->vue->titreVue = "Enregistrement d'un stage";
        ...
        $lesParametres[3] = $_POST["dateDebut"];
        $lesParametres[4] = $_POST["dateFin"];
        $lesParametres[5] = $_POST["dateVisite"];
        ...
        if ($ok==null) {
            $this->vue->message = "Stage enregistr&";
        } else {
            $msg = "";
            $this->vue->message = "Echec de l'enregistrement ".$msg;
        }
