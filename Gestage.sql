...
--
-- Client: localhost
-- Généré le: Ven 25 Avril 2014 à 08:43
-- Version du serveur: 5.5.34
-- Version de PHP: 5.4.6-1ubuntu1.6
...
(4, 2, 4, 'Monsieur', 'HERBERT', 'Quentin', '0606060606', 'qherbert@gmail.com', '0606070707', '2SLAM', 'NULL', 'qherbert', '5ecc979ccad908a06299f8da5066f7c6ba49f8a9'),
...
CREATE TABLE IF NOT EXISTS `STAGE` (
  ...
  `DATEVISITESTAGE` varchar(128) NOT NULL,
  ...
  KEY `STAGE_ibfk_3` (`IDMAITRESTAGE`),
  KEY `STAGE_ibfk_4` (`IDORGANISATION`)
...
(10, 0, 12, 1, 15, '2016-01-04', '2016-01-05', '2014-12-05', 'Nantes', 'aucun', 'aucun', 'aucun', 'aucun', NULL);
